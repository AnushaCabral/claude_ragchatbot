...
class VectorStore:
        ...
        try:
            ...
            if results["documents"][0] and results["metadatas"][0]:
                ...
                if distance < 1.5:
                    ...
                    print(
                        f"Course '{course_name}' no good match (distance: {distance:.3f})"
                    )
                    return None
        except Exception as e:
    ...
    def get_source_link(
        self, course_title: str, lesson_number: Optional[int] = None
    ) -> Optional[str]:
        """
        ...
        try:
            ...
            print(
                f"Error getting source link for '{course_title}', lesson {lesson_number}: {e}"
            )
            return None
